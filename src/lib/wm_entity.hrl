...
-record(job,
        {id :: string(), name = "" :: string(), cluster_id = "" :: cluster_id(), nodes = [] :: [node_id()],
         state = "Q" :: string(), state_details = "" :: string(), start_time = "" :: string(),
         submit_time = "" :: string(), end_time = "" :: string(), duration = 0 :: pos_integer(),
         job_stdin = "" :: string(), job_stdout = "" :: string(), job_stderr = "" :: string(),
         input_files = [] :: [string()], output_files = [] :: [string()], workdir = "" :: string(),
         user_id = "" :: user_id(), hooks = [] :: [hook_id()], env = [] :: [{string(), string()}],
